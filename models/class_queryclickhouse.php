...
function class_queryClickHouse($ConnectionId, $Query, $ArrayFilter, $array_groupby, $Limit, $start = null, $length = null, $array_sumby = null, $OrderBy = null) {
    ...
    $query_order_by = '';
    if (!empty($OrderBy)) {
        // ClickHouse usa la misma sintaxis ORDER BY que MySQL
