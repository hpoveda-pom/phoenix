                ...
                <div class="card position-relative border-0">
                  ...
                  -->
                    <ul class="nav d-flex flex-column my-3">
                      ...
                      <li class="nav-item">
                        <a class="nav-link px-3" href="pipelines.php">
                          <span class="me-2">-</span>
                          <svg xmlns="http://www.w3.org/2000/svg" width="14px" height="14px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-zap me-2 text-body"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>
                          Pipelines
                        </a>
                      </li>
                      <li class="nav-item">
                    ...
                    <!-- Switch para activar/desactivar Debug - Solo para administradores -->
                    <div class="px-3 py-2">
