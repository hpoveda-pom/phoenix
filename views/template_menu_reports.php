  ...
  <hr class="navbar-vertical-line">
    <?php foreach ($array_category as $key_category => $row_category) { 
      ...
      <div class="nav-item-wrapper">
        ...
        <div class="parent-wrapper reports-<?php echo $row_category['CategoryId']; ?>">
          <ul class="nav collapse <?php echo $collapse_show; ?> parent" data-bs-parent="#navbarVerticalNav" id="reports-<?php echo $categoryId; ?>">
            <li class="collapsed-nav-item-title d-none"><?php echo $row_category['Title']; ?></li>
                      ...
                      <li class="nav-item">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent <?php echo $subcategory_collapse_show; ?>" data-bs-parent="#e-commerce" id="nv-reports-<?php echo $row_subcategory['CategoryId']; ?>">
                            <!-- REPORTS ITEM START  -->
                            <?php
